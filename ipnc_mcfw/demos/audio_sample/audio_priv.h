...
#define AUDIO_SAMPLE_RATE_SUPPORTED							16000   // < Only
                                                                    // 16KHz
                                                                    // supported
#define AUDIO_CHANNELS_SUPPORTED							1   // < Only
                                                                // mono
#define AUDIO_CHANNEL_SAMPLE_INTERLEAVE_LEN					1
#define AUDIO_SAMPLES_TO_READ_PER_CHANNEL					(250)   // <
                                                                    // Ensure
                                                                    // to
                                                                    // align
                                                                    // with
...
#define AUDIO_PLAYBACK_SAMPLE_MULTIPLIER					64  /* For some
                                                                 * reason, we
                                                                 * have to
                                                                 * read /
                                                                 * feed this
 ...
 * SAMPLES_TO_READ_PER_CHANNEL * PLAYBACK_SAMPLE_MULTIPLIER Driver will
 * consume lot of time in sending out this data, hence huge backend delay
...
#else
#define	ALSA_CAPTURE_DEVICE		"default"
#endif
...
#define	AUDIO_MAX_PLAYBACK_BUF_SIZE						(120*1024)  /* Max hd
                                                                     * read
                                                                     * for ~4
                                                                     * secs
                                                                     * worth
