/* ===========================================================================
 * * @file msg_util.c * * @path $(IPNCPATH)/util/ * * @desc An easier message
 * queue interface. * . * Copyright (c) Appro Photoelectron Inc.  2008 * * Use
 * of this software is controlled by the terms and conditions found * in the
