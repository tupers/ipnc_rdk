...
typedef struct {
	...
	Int16 orientation;
	Int16 sensitiveness;
	Int16 tamperSensitiveness;
	Int16 resetCounter;
	UInt32 presentAdjust;

	Int16 minPersonSize[2];
	Int16 maxPersonSize[2];
	Int16 minVehicleSize[2];
	Int16 maxVehicleSize[2];

	Int8 numPolygons;
	DMVALpolygon polygon[4];
	...
	UInt32 maxNoObj;
	UInt8 metaData[VALINK_METADATASIZE];
	UInt8 prevMetaData[VALINK_METADATASIZE];

	UInt32 objectCount;
	UInt32 vaAlgChanged;
	UInt32 tamperEventDone;

	UInt32 eventRecStatus;
