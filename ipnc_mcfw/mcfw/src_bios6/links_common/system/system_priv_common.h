...
#define ROTATEFRAME_LINK_TSK_PRI		 (12)
...
#define IMG_LINK_TSK_PRI				 (6)
#define IMG_LINK_PROCESSTSK_PRI			 (5)
...
#define ROTATEFRAME_LINK_TSK_STACK_SIZE          (SYSTEM_DEFAULT_TSK_STACK_SIZE)
...
#define IMG_LINK_TSK_STACK_SIZE				(SYSTEM_DEFAULT_TSK_STACK_SIZE)
#define IMG_LINK_PROCESSTSK_STACK_SIZE		(SYSTEM_DEFAULT_TSK_STACK_SIZE)
