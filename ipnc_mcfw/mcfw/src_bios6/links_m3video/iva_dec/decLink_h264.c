...
static IH264VDEC_Handle dec_link_h264_create(Int scratchGroupID,const IH264VDEC_Fxns * fxns,
                                             const IH264VDEC_Params * prms);
static Void dec_link_h264_delete(IH264VDEC_Handle handle,Int scratchGroupID);
...
static IH264VDEC_Handle dec_link_h264_create(Int scratchGroupID,
                                             const IH264VDEC_Fxns * fxns,
                                             const IH264VDEC_Params * prms)
{
    return ((IH264VDEC_Handle) ALG_create(scratchGroupID,
                                          (IALG_Fxns *) fxns,
...
static Void decLink_h264_freersrc(DecLink_H264Obj * hObj, Int rsrcMask)
{
    ...
    {
        dec_link_h264_delete(hObj->algHandle,hObj->scratchID);
        hObj->algHandle = NULL;
    }
}
                          ...
                          Int linkID, Int channelID, Int scratchGroupID)
{
    ...
    hObj->algHandle =
        dec_link_h264_create(scratchGroupID,
                             (IH264VDEC_Fxns *) & H264VDEC_TI_IH264VDEC_MULTI,
                             &hObj->staticParams);
