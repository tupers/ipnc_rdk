...
static IJPEGVDEC_Handle dec_link_jpeg_create(const IJPEGVDEC_Fxns * fxns,
                                             ...
                                             Int scratchGroupID);
static Void dec_link_jpeg_delete(IJPEGVDEC_Handle handle,Int scratchGroupID);
...
static IJPEGVDEC_Handle dec_link_jpeg_create(const IJPEGVDEC_Fxns * fxns,
                                             ...
                                             Int scratchGroupID)
{
    return ((IJPEGVDEC_Handle) ALG_create(scratchGroupID,(IALG_Fxns *) fxns,
...
static Void decLink_jpeg_freersrc(DecLink_JPEGObj * hObj, Int rsrcMask)
{
    ...
    {
        dec_link_jpeg_delete(hObj->algHandle,hObj->scratchID);
        hObj->algHandle = NULL;
    }
}
