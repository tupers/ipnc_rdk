...
static IMPEG4VDEC_Handle dec_link_mpeg4_create(const IMPEG4VDEC_Fxns * fxns,
                                             ...
                                             Int scratchGroupID)
{
    return ((IMPEG4VDEC_Handle) ALG_create(scratchGroupID,
                                          (IALG_Fxns *) fxns,
...
static Void dec_link_mpeg4_delete(IMPEG4VDEC_Handle handle,Int scratchGroupID)
{
...
static Void decLink_mpeg4_freersrc(DecLink_MPEG4Obj * hObj, Int rsrcMask)
{
    ...
    {
        dec_link_mpeg4_delete(hObj->algHandle,hObj->scratchID);
        hObj->algHandle = NULL;
    }
}
