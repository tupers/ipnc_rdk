...
typedef enum EncDec_ResolutionClass {
	...
	UTILS_ENCDEC_RESOLUTION_CLASS_3MP,
    UTILS_ENCDEC_RESOLUTION_CLASS_1080P,
    UTILS_ENCDEC_RESOLUTION_CLASS_720P,
    UTILS_ENCDEC_RESOLUTION_CLASS_960P, //1280 * 960
...
#define UTILS_ENCDEC_RESOLUTION_CLASS_3MP_WIDTH                           (2048)
#define UTILS_ENCDEC_RESOLUTION_CLASS_3MP_HEIGHT                          (1536)
