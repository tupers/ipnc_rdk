...
/////////////////////////////////////////////////////////////////////////////
typedef enum {
	SCD_SENSITIVITY_VERYLOW	 =  0,
	SCD_SENSITIVITY_LOW		 =  1,
	SCD_SENSITIVITY_MIDLO	 =  2,
	SCD_SENSITIVITY_MID		 =  3,
	SCD_SENSITIVITY_MIDHI	 =  4,
	SCD_SENSITIVITY_HIGH	 =  5,
	SCD_SENSITIVITY_VERYHIGH =  6
} SCD_Sensitivity;
