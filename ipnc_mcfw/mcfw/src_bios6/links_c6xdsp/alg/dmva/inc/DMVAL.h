...
#define DMVAL_MAX_FRAME_METADATA (2)
...
typedef enum
{
  ...
  DMVAL_PARAM_IGNOREZONE,
               /**< Used to control bckground image ignore mask
                    in IMD and SMETA algorithm.

                    This is an optional parameter.
               */
  DMVAL_PARAM_BACKGROUND_MEAN_UPDATE_RATE,
              /**< Used to control the rate at which mean of gaussian 
                   model of background image is updated. Applicable to
                   TZ-IMD-SMETA algorithms. This parameter is expected 
                   in Q15 format.Higher value of this indicates fast 
                   updation of the mean of the background image. In most 
                   of the use case default value should behave adequetly.
              */
  DMVAL_PARAM_BACKGROUND_VAR_UPDATE_RATE,
              /**< Used to control the rate at which variance of gaussian 
                   model of background image is updated. Applicable to
                   TZ-IMD-SMETA algorithms. This parameter is expected 
                   in Q15 format.Higher value of this indicates fast 
                   updation of the varaince of the background image. In most 
                   of the use case default value should behave adequetly.
              */
  DMVAL_PARAM_BACKGROUND_VAR_FACTOR_TH,
              /**< Used as multiplication factor with variance of background 
                   model before comparing with actual variance of the current 
                   pixel.This parameter is expected in Q8 format. Higher 
                   value of this will result in less foreground pixels. In most 
                   of the use case default value should behave adequetly.Applicable 
                   to TZ-IMD-SMETA algorithms.
              */
  DMVAL_PARAM_IMD_CAMERA_NOISE_TH,
              /**< Used as another threshold for variance of current pixel, to 
                   discard varation caused due to normal camera noise. Expected 
                   in Q15 format and applicable to TZ-IMD-SMETA algorithms. Value 
                   for this threshold should be choosen as per camera property. In most 
                   of the use case default value should behave adequetly.
                */
  DMVAL_PARAM_TZOBJ_ADAPT_RATE,
               /**< Controls the rate at which object property changes in the view of scene.
                    Expected in Q15 format, and applicable to TZ,OC & SMETA algorithm.
                    Object property includes size/appearance etc. In most 
                   of the use case default value should behave adequetly.
               */
  DMVAL_PARAM_TZ_MOTION_TH,
               /**< Used as a threshold to control minimum required number of motion pixel 
                    around a moving object to get this object detected by algorithm. If this 
                    threshold is high then slower moving objects will have lower probablity to
                    get detected as an object. Expected in Q15 format and applicable to TZ and 
                    OC algorithm. In most of the use case default value should behave adequetly.
               */
  DMVAL_PARAM_SMETA_RSVD1_TH,
  DMVAL_PARAM_SMETA_RSVD2_TH,
  DMVAL_PARAM_SMETA_RSVD3_TH,
  DMVAL_PARAM_SMETA_RSVD4_TH,
...
typedef enum
{
 DMVAL_NONE_FRAME_METADATA = 0,
 DMVAL_FOREGROUND_FRAME_METADATA = 1
}DMVALfrmMetaType;
...
/**
  @ struct DMVALfrmMeta
  @ brief  This structure defines the format in which 
           DMVAL will provide some of the frame level meta 
           data information. For specific information about 
  @ param type  : defines the information about what kaind of this meta data.           
  @ param addr  : address of the buffer where meta data information is laying
  @ param sizeInBytes : total size of the meta data information in bytes.
  @ param onePixelInfoSizeInBits : Size of the one pixel information in bits. If 
                                   datas are bit packed then this value will be '1'.
  */
typedef struct
{
 XDAS_Int32 type;
 XDAS_Void *addr;
 XDAS_Int32 sizeInBytes;
 XDAS_Int8 onePixelInfoSizeInBits;
}DMVALfrmMeta;
