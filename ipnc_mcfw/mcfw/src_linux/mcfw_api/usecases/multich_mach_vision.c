...
Void MultiCh_createMachVision()
{
	...
	gVcamModuleContext.frameProcessId = SYSTEM_LINK_ID_INVALID;
    /* IPC struct init */
    ...
    gValgModuleContext.algId = SYSTEM_DSP_LINK_ID_IMG;
    ipcFramesOutDspId = SYSTEM_DSP_LINK_ID_IPC_FRAMES_OUT_0;
	gVcamModuleContext.frameProcessId = SYSTEM_HOST_LINK_ID_FRAMEPROCESS;
...
//		cameraPrm.outQueParams[1].nextLink = gVsysModuleContext.muxId;;
    ...
    ipcFramesInDspPrm.baseCreateParams.outQueParams[0].nextLink = gValgModuleContext.algId;
    ...
    /* DSP IPC FRAMES OUT */
    ipcFramesOutDspPrm.baseCreateParams.inQueParams.prevLinkId = gValgModuleContext.algId;
    ...
    ipcFramesInHostPrm.baseCreateParams.inQueParams.prevLinkQueId = 0;
 	ipcFramesInHostPrm.baseCreateParams.outQueParams[0].nextLink =  gVcamModuleContext.frameProcessId;  
	...
	ipcFramesOutHostPrm.baseCreateParams.inQueParams.prevLinkId = gVcamModuleContext.frameProcessId;  
    ...
    muxPrm.inQueParams[1].prevLinkId = dupId[MJPEG_DUP_LINK_IDX];
    muxPrm.inQueParams[1].prevLinkQueId = 1;
    ...
    System_linkCreate(gValgModuleContext.algId,&imgPrm,sizeof(imgPrm));   
	...
	System_linkCreate(gVcamModuleContext.frameProcessId,&frameProcessPrm,sizeof(FrameProcessHostLink_CreateParams));
...
Void MultiCh_deleteMachVision()
{
	...
	System_linkDelete(gVcamModuleContext.frameProcessId);
    ...
    System_linkDelete(gValgModuleContext.algId);
