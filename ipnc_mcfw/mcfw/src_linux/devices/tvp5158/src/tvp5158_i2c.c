...
Int32 Device_tvp5158PatchDownload ( Device_Tvp5158Obj * pObj, UInt32 devId )
{
    ...
    while ( patchSize )
    {
        ...
        status = OSA_i2cWrite8 (&gDevice_tvp5158CommonObj.i2cHandle, pCreateArgs->deviceI2cAddr[pObj->instId], regAddr, patchAddr, wrSize );
                            ...
                            Device_VideoDecoderRegRdWrParams * pPrm )
{
    ...
    status = OSA_i2cWrite8 (&gDevice_tvp5158CommonObj.i2cHandle, pCreateArgs->deviceI2cAddr[pObj->instId], pPrm->regAddr, pPrm->regValue8, pPrm->numRegs );
                           ...
                           Device_VideoDecoderRegRdWrParams * pPrm )
{
    ...
    status = OSA_i2cRead8 (&gDevice_tvp5158CommonObj.i2cHandle, pCreateArgs->deviceI2cAddr[pObj->instId], pPrm->regAddr, pPrm->regValue8, pPrm->numRegs);
