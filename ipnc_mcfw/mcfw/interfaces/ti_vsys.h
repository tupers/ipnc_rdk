...
#include "link_api/imgAlg_data.h"
...
typedef enum
{
    SYS_IMGALG_ENABLE,
    SYS_IMGALG_DISABLE,
    SYS_IMGALG_STATIC_IMG,
    SYS_IMGALG_SENSOR_IMG,
    SYS_SET_IMGALG_PARAM,
    SYS_GET_IMGALG_PARAM,
    SYS_ENABLE_IMGALG_DBGMODE,
    SYS_DISABLE_IMGALG_DBGMODE
} VSYS_DSPIMG_SETPARAM;
