...
/**
    ...
    \param NONE
*/
#define SYSTEM_COMMON_CMD_CPU_LOAD_CALC_GET			(0x8FF0)
...
#define SYSTEM_COMMON_CMD_DSP_MSG			  (0x9013)
/* @} */
...
typedef struct
{
	unsigned int prfload;
} SystemCommon_DanimicParams;
...
typedef struct SystemCommon_dspPrm {
