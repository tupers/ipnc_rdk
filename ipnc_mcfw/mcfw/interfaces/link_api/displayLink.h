...
#define DISPLAY_LINK_CMD_STOP_DEV					(0x4006)

#define DISPLAY_LINK_CMD_START_DEV					(0x4007)	
...
*/
#define DISPLAY_LINK_CMD_SWITCH_INPUT_MODE  		(0x4008)

#define DISPLAY_LINK_CMD_PRINT_BUFFER_STATISTICS  	(0x4009)

typedef enum
{
    DISPLAY_LINK_DISPLAY_SC1 = 0,
    /**< Primary Display path,
         This path has DEIH on TI816x or DEIM on TI814x/TI8107 */
    DISPLAY_LINK_DISPLAY_SC2,
    /**< Auxiliary Display path,
         This path has DEIM on TI816x or only Scalar on
         TI814x/TI8107 */
    DISPLAY_LINK_DISPLAY_BP0,
    /**< Bypass 0 Display Path */
    DISPLAY_LINK_DISPLAY_BP1,
    /**< Bypass 1 Display Path */
    DISPLAY_LINK_DISPLAY_SD,
    /**< Secondary 0 Display Path */
    DISPLAY_LINK_DISPLAY_AUTO_SELECT
    /**< Select input path for display driver based on Link ID as shown below
         DISPLAY0 -> BP0
         DISPLAY1 -> BP1
         DISPLAY2 -> SEC1 */
...
typedef struct
{
    ...
    UInt32                   displayId;
    /**< Used to select display driver to be used for this link.
         See #DisplayLink_DisplayId */
