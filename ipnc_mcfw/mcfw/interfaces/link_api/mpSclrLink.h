...
/**< MP_SCLR command to get current output resolution of given channel  
        This feature is not yet supported */
#define MP_SCLR_LINK_CMD_SET_HMPCH_FORWARD      (0x7003)
/**< MP_SCLR command to enable/disable a HMP Forwarding for a given channel
        No real MP scaling will be performed once this is enabled */
#define MP_SCLR_LINK_CMD_MAX                    (0x7004)
/**< MP_SCLR Command upper limit - Guard, does nothing */

#define MP_SCLR_LINK_CMD_ENABLE_CHANNEL			(0x7005)
#define MP_SCLR_LINK_CMD_DISABLE_CHANNEL		(0x7006)

/* @} */

#define MP_SCLR_LINK_SC5                        (0)
/**< MP_SCLR SC 5 instace to be used */
#define MP_SCLR_LINK_SEC0_SC3_VIP0              (1)
/**< MP_SCLR SC 3 instace to be used */
#define MP_SCLR_LINK_SEC1_SC4_VIP1              (2)
/**< MP_SCLR SC 4 instace to be used */
#define MP_SCLR_LINK_MAX_CH                     (4)
/**< Maximum channels per instance of MP SCLR */
#define MP_SCLR_LINK_MAX_FWD_CH                 (SYSTEM_MAX_CH_PER_OUT_QUE)
/**< Maximum number of channels MP SCLR support */
...
/**
    \brief MP_SCLR params to enable a HMP Forwarding of a given channel
           No real MP scaling will be performed once this is enabled 
*/
typedef struct MpSclrLink_chDynSetHmpFwd
{
    UInt32 enableHmpFwdFlag;
    /**< Set to 1 if enable a HMP channel Forwarding, HMP scaling will not
      *  be performed on these channels, cropping can be enabled in SWMS
      *  Added for checking the validity before Forwarding the Frame */
    UInt32 chId;
    /**< output channel Id */
} MpSclrLink_chDynSetHmpFwd;

/**
    \brief MP_SCLR link set ouput resolution
*/
typedef struct MpSclrLink_chDynamicSetOutRes
{
    UInt32 chId;
    /**< output channel Id */
    UInt32 width;
...
/**
    \brief MP_SCLR link channel info
*/
typedef struct
{
	UInt32 channelId;
	UInt32 enable;
} MpSclrLink_ChannelInfo;
