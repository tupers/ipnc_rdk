...
# TBD
  ifeq ($(SOC),ti8107)
    ifeq ($(CORE),m3video)
      PLATFORM_XDC = "ti.platforms.evmTI813X:core0"
    else
      PLATFORM_XDC = "ti.platforms.evmTI813X:core1"
    endif
  endif
  ...
  AOBJEXT = oa$(FORMAT_EXT)$(ISA)$(ENDIAN_EXT)
...
ifneq ($(SOC),ti8107)
  ifeq ($(ISA),c674)
    ...
    AOBJEXT = oa$(FORMAT_EXT)674$(ENDIAN_EXT)
