...
SOAP_SOURCE_STAMP("@(#) soapServer.c ver 2.8.14 2013-04-04 07:50:52 GMT")
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve_request(struct soap *soap)
{
	...
	fprintf(stderr, "in  [onvif] soap_serve_request ....%s... \n", soap->tag);
	...
	if (!soap_match_tag(soap, soap->tag, "d:ProbeMatches"))
		return soap_serve___d__ProbeMatches(soap);
	if (!soap_match_tag(soap, soap->tag, "d:Resolve"))
		return soap_serve___d__Resolve(soap);
	if (!soap_match_tag(soap, soap->tag, "d:ResolveMatches"))
		return soap_serve___d__ResolveMatches(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___d__ProbeMatches(struct soap *soap)
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___d__Resolve(struct soap *soap)
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___d__ResolveMatches(struct soap *soap)
