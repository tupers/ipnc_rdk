...
SOAP_SOURCE_STAMP("@(#) soapClient.c ver 2.8.14 2013-04-04 07:50:52 GMT")
...
{	struct __d__Hello soap_tmp___d__Hello;
	...
	soap->encodingStyle = NULL;
	soap_tmp___d__Hello.d__Hello = d__Hello;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___d__Hello(soap, &soap_tmp___d__Hello);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___d__Hello(soap, &soap_tmp___d__Hello, "-d:Hello", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{
	soap_default___d__Hello(soap, _param_2);
	soap_begin(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get___d__Hello(soap, _param_2, "-d:Hello", NULL);
	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
		soap->error = SOAP_NO_METHOD;
	if (soap->error
	 || soap_body_end_in(soap)
...
{	struct __d__Bye soap_tmp___d__Bye;
	...
	soap->encodingStyle = NULL;
	soap_tmp___d__Bye.d__Bye = d__Bye;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___d__Bye(soap, &soap_tmp___d__Bye);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___d__Bye(soap, &soap_tmp___d__Bye, "-d:Bye", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{
	soap_default___d__Bye(soap, _param_3);
	soap_begin(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get___d__Bye(soap, _param_3, "-d:Bye", NULL);
	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
		soap->error = SOAP_NO_METHOD;
	if (soap->error
	 || soap_body_end_in(soap)
...
{	struct __d__Probe soap_tmp___d__Probe;
	...
	soap->encodingStyle = NULL;
	soap_tmp___d__Probe.d__Probe = d__Probe;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___d__Probe(soap, &soap_tmp___d__Probe);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___d__Probe(soap, &soap_tmp___d__Probe, "-d:Probe", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{
	soap_default___d__Probe(soap, _param_4);
	soap_begin(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get___d__Probe(soap, _param_4, "-d:Probe", NULL);
	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
		soap->error = SOAP_NO_METHOD;
	if (soap->error
	 || soap_body_end_in(soap)
...
{
	soap_default___d__ProbeMatches(soap, _param_5);
	soap_begin(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get___d__ProbeMatches(soap, _param_5, "-d:ProbeMatches", NULL);
	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
		soap->error = SOAP_NO_METHOD;
	if (soap->error
	 || soap_body_end_in(soap)
...
{	struct __d__Resolve soap_tmp___d__Resolve;
	...
	soap->encodingStyle = NULL;
	soap_tmp___d__Resolve.d__Resolve = d__Resolve;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___d__Resolve(soap, &soap_tmp___d__Resolve);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___d__Resolve(soap, &soap_tmp___d__Resolve, "-d:Resolve", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{
	soap_default___d__Resolve(soap, _param_6);
	soap_begin(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get___d__Resolve(soap, _param_6, "-d:Resolve", NULL);
	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
		soap->error = SOAP_NO_METHOD;
	if (soap->error
	 || soap_body_end_in(soap)
...
{	struct __d__ResolveMatches soap_tmp___d__ResolveMatches;
	...
	soap->encodingStyle = NULL;
	soap_tmp___d__ResolveMatches.d__ResolveMatches = d__ResolveMatches;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___d__ResolveMatches(soap, &soap_tmp___d__ResolveMatches);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___d__ResolveMatches(soap, &soap_tmp___d__ResolveMatches, "-d:ResolveMatches", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{
	soap_default___d__ResolveMatches(soap, _param_7);
	soap_begin(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get___d__ResolveMatches(soap, _param_7, "-d:ResolveMatches", NULL);
	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
		soap->error = SOAP_NO_METHOD;
	if (soap->error
	 || soap_body_end_in(soap)
...
{	struct __dn__Probe soap_tmp___dn__Probe;
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get_d__ProbeMatchesType(soap, dn__ProbeResponse, "dn:ProbeResponse", "d:ProbeMatchesType");
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
