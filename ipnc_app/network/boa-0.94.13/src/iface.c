...
int retrieve_system_video_channels_id(request *req, node_t *node)
{
	...
	if(pSysInfo->lan_config.nWhiteBalance == 0)
	   ...
	   sprintf(VideoInputChannel.whiteBalanceMode,"Day_D65");
	else if(pSysInfo->lan_config.nWhiteBalance == 2)
	   sprintf(VideoInputChannel.whiteBalanceMode,"Day_D55");
	else if(pSysInfo->lan_config.nWhiteBalance == 3)
	   sprintf(VideoInputChannel.whiteBalanceMode,"fluorescent");
	else if(pSysInfo->lan_config.nWhiteBalance == 4)
	   sprintf(VideoInputChannel.whiteBalanceMode,"incandescent");
...
int update_system_video_channels_id(request *req, node_t *node)
{
	...
	while(tag) {
		if(strcmp(tag->name, TAG_id) == 0) {
			...
			else if(strncmp(VideoInputChannel.whiteBalanceMode,"Day_D65",3) == 0)
               strcpy(VideoInputChannel.whiteBalanceMode,"1");
			else if(strncmp(VideoInputChannel.whiteBalanceMode,"Day_D55",3) == 0)
               strcpy(VideoInputChannel.whiteBalanceMode,"2");
			else if(strncmp(VideoInputChannel.whiteBalanceMode,"Florescent",3) == 0)
               strcpy(VideoInputChannel.whiteBalanceMode,"3");
			else if(strncmp(VideoInputChannel.whiteBalanceMode,"Incandescent",3) == 0)
               strcpy(VideoInputChannel.whiteBalanceMode,"4");
...
{
	const char *whiteBalanceModeStr = "opt=\"Auto,Day_D65,Day_D55,Florescent,Incandescent\"";
...
int retrieve_system_deviceinfo(request *req, node_t *node)
{
	...
	sprintf(DeviceInfo.firmware_version,"%s", IPNC_APP_VERSION);
	...
	if(channel_id == 0){
	 if(pSysInfo->lan_config.nStreamType == 0){
		...
		if(pSysInfo->lan_config.nVideocombo == 0){
		  ...
		  if(pSysInfo->lan_config.nRateControl1 == 0)
			sprintf(StreamingChannel.videoQualityControlType,"VBR");
		  else if(pSysInfo->lan_config.nRateControl1 == 1)
	 ...
	 if (pSysInfo->lan_config.nStreamType == 1){
		...
		if (pSysInfo->lan_config.nVideocombo == 0){
		  ...
		  if(pSysInfo->lan_config.nRateControl2 == 0)
			sprintf(StreamingChannel.videoQualityControlType,"VBR");
		  else if(pSysInfo->lan_config.nRateControl2 == 1)
			sprintf(StreamingChannel.videoQualityControlType,"CBR");
...
int retrieve_custom_video_channels_id(request *req, node_t *node)
{
	...
	else if(pSysInfo->lan_config.mirror == 4)
	   sprintf(VideoSetting.mirrorMode,"270ROTATION");
	else if(pSysInfo->lan_config.mirror == 5)
	   sprintf(VideoSetting.mirrorMode,"90ROTATION");
...
int retrieve_custom_video_channels_id_capabilities(request *req, node_t *node)
{
	...
	const char *mirrorModestr = "opt=\"OFF,HORIZONTAL,VERTICAL,BOTH,270ROTATION,90ROTATION\"";
...
int update_custom_video_channels_id(request *req, node_t *node, tag_t *parentTag)
{
	...
	while(tag) {
		if(strcmp(tag->name, TAG_id) == 0) {
			...
			else if(strncmp(VideoSetting.mirrorMode,"270ROTATION",3) == 0)
               strcpy(VideoSetting.mirrorMode,"4");
			else if(strncmp(VideoSetting.mirrorMode,"90ROTATION",3) == 0)
               strcpy(VideoSetting.mirrorMode,"5");
...
int retrieve_custom_camera_channels_id(request *req, node_t *node)
{
	...
	sprintf(CameraSetting.tnfltCtrl,"%d",pSysInfo->advanceMode.vnfEnable);
