...
#define EZCAM_UPDATE_TOOL		"/opt/ipnc/update/updateCopy"
#define EZCAM_ALG_DBGIMG		"/opt/ipnc/update/alg_staticImg"
#define SDS_TEST_PATH			"/opt/test"


extern int InitRemoteDebugMsgDrv(int key);

extern void CleanupRemoteDebugMsgDrv();

extern int Remote_printf(char *format, ...);
