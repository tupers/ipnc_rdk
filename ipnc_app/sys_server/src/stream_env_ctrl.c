...
int EnvSaveFrameImg(char *filename)
{
	...
	ret = SaveFrameImg(filename);
	if(ret<0)
	{
		printf("SaveFrameImg fail\n");
		return -1;
	}
...
{
	return Update_Alg_DbgImg(data,size);
}
